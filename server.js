...
db.serialize(() => {
    db.run("DROP TABLE IF EXISTS apiData");
    db.run("CREATE TABLE IF NOT EXISTS apiData (id INTEGER UNIQUE, title TEXT, price REAL, description TEXT, category TEXT, image TEXT, sold INTEGER, dateOfSale TEXT)");
});

// Function to insert sample data into SQLite
async function insertSampleData() {
    try {
        ...
        // Insert the sample data into the SQLite database
        db.serialize(() => {
            const stmt = db.prepare("INSERT INTO apiData (id, title, price, description, category, image, sold, dateOfSale) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
...
// Trigger the function to insert sample data
insertSampleData();
